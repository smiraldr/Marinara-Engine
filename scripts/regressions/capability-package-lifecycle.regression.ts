...
try {
  ...
  assert.deepEqual(supportedCapabilityApi, { major: 1, minor: 22 });
  ...
  assert.match(
    ...
    /requires capability API 2\.0; this Engine supports 1\.22/,
  );
  ...
  assert.match(
    ...
    /requires capability API 1\.23; this Engine supports 1\.22/,
  );
